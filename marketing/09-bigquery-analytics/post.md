...
image: marketing/_assets/ga4-snapshot.png
imageAlt: GA4 analytics dashboard — the kind of report AILANG produces with deterministic SQL generation under a Net @limit=20 budget.
assets:
